 ...
 * @version 2.3
 * Turkish Translator: Machine -> www.mybb.com.tr
 * Translator Website: http://torrentdizindir.com
 */
...
{
	return array(
		'name' => 'Facebook İle Bağlan',
		'description' => 'Kullanıcılarınızın facebook hesaplarıyla sitenize kayıt olmasını veya oturum açmasını sağlar. <br /> <img src="http://destek.mybb.com.tr/mybb-icon.png" width="16" height="16" alt="mybb"/>Türkçe Çeviri: <a href="http://torrentdizindir.com" target="_blank" title="MCTR Support Team Member"><strong>Machine</strong></a>',
